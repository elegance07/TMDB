...
class TMDb
{
	...
	public function getSimilarMovies($id, $page = 1, $lang = NULL)
	{
        ...
        /**
	 * Retrieve similar Tvshow for a particular TV
	 *
	 * @param mixed $id					TMDb-id or IMDB-id
	 * @param int $page					Number of the page with results (default first page)
	 * @param mixed $lang				Filter the result with a language (ISO 3166-1) other then default, use FALSE to retrieve results from all languages
	...
	public function getLatestMovie()
	{
        ...
        /**
	 * Retrieve newest tv added to TMDb
	 *
	 * @return TMDb result array
	 */
	 ...
	 * @return TMDb result array
	 */
	public function getOnTheAirTVShows()
	{
		return $this->_makeCall('tv/on_the_air');
	}

        /**
	 * Retrieve newest tv added to TMDb airing_today
	 *
	 * @return TMDb result array
	 */
	public function getAiringTodayTVShows()
	{
		return $this->_makeCall('tv/airing_today');
	}
...
/**
	 ...
	 * @return TMDb result array
	 */
	public function getPopularTVShows($page = 1, $lang = NULL)
	{
		$params = array(
			'page' => (int) $page,
			'language' => ($lang !== NULL) ? $lang : $this->getLang(),
	...
	public function getMovieChanges($id)
	{
        ...
        /**
	 * Retrieve changes for a particular tv
	 *
	 * @param mixed $id					TMDb-id or IMDB-id
	 * @return TMDb result array
	 */
	public function getTvChanges($id)
	{
		return $this->_makeCall('tv/'.$id.'/changes');
	}
	...
	public function getChangedMovies($page = 1, $start_date = NULL, $end_date = NULL)
	{
        ...
        /**
	 * Retrieve all id's from changed tv
	 *
	 * @param int $page					Number of the page with results (default first page)
	 * @param string $start_date		String start date as YYYY-MM-DD
	 * @param string $end_date			String end date as YYYY-MM-DD (not inclusive)
	 * @return TMDb result array
	 */
	public function getChangedTv($page = 1, $start_date = NULL, $end_date = NULL)
	{
		$params = array(
			'page' => (int) $page,
			'start_date' => $start_date,
		...
		return $this->_makeCall('tv/changes', $params);
	}
